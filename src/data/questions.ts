const questions = [
  ...
  },
  {
    ...
    options: ["Boolean", "Decimal", "Character", "Float"],
  ...
  {
    question:
      "What is the correct syntax to refer to an external script called 'app.js'?",
    options: [
      "<script src='app.js'>",
      "<script href='app.js'>",
      "<script ref='app.js'>",
  ...
  {
    question:
      "Which Git command is used to upload local content to a remote repository?",
